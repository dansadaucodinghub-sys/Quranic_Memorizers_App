...
{
    public function id(): SeedId { return new SeedId('20260910060200_seed_quran_governance_authorization'); }
    public function description(): string { return 'Seed exact Platform Qur’an governance permissions and role mappings.'; }
    public function dependencies(): array { return [new SeedId('20260910060100_seed_quran_reference_sources')]; }
