...
{
    public function id(): SeedId { return new SeedId('20260910060100_seed_quran_reference_sources'); }
    public function description(): string { return 'Seed the three approved Tanzil source definitions without text or artifacts.'; }
    public function dependencies(): array { return [new SeedId('20260902050100_seed_people_identity_resolution_authorization')]; }
