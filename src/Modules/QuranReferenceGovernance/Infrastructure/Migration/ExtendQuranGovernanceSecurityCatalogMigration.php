...
{
    public function id(): MigrationId { return new MigrationId('20260910060200_extend_quran_governance_security_catalog'); }
    public function description(): string { return 'Extend fixed security catalogs for Qur’an release governance.'; }
    public function dependencies(): array { return [(new CreateQuranReferenceGovernanceMigration())->id()]; }
