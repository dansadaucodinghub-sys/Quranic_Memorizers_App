...
final readonly class CompetitionP6VerifyConsoleCommand implements ConsoleCommand
{
    ...
    public function execute(ConsoleInput $input, ConsoleOutput $output): int
    {
        ...
        try {
            ...
            $this->requireCount($pdo, "SELECT COUNT(*) FROM qmdb_schema_migrations WHERE status='APPLIED' AND migration_id IN ('20260911140000_create_competition_judging_scoring','20260912100000_complete_competition_p6_immutable_records','20260912110000_correct_competition_p6_lifecycle_vocabulary','20260912120000_complete_competition_p6_runtime_contracts')", 4, 'P6 migrations are incomplete.');
