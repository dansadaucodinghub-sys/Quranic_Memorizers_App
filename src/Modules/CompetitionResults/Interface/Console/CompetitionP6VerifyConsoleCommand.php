...
final readonly class CompetitionP6VerifyConsoleCommand implements ConsoleCommand
{
    ...
    public function execute(ConsoleInput $input, ConsoleOutput $output): int
    {
        ...
        try {
            ...
            $required = ['competition_rounds','competition_round_participants','competition_judges','competition_judge_panels','competition_judge_assignments','competition_judge_conflicts','competition_scoring_rubrics','competition_scoring_criteria','competition_penalty_rules','competition_tie_break_rules','competition_score_sheets','competition_score_entries','competition_score_penalties','competition_score_sheet_events','competition_result_runs','competition_result_rows','competition_disqualifications','competition_public_result_consents','competition_appeal_windows','competition_appeals','competition_appeal_events'];
            ...
            $this->requireCount($pdo, "SELECT COUNT(*) FROM qmdb_schema_migrations WHERE status='APPLIED' AND migration_id IN ('20260911140000_create_competition_judging_scoring','20260912100000_complete_competition_p6_immutable_records','20260912110000_correct_competition_p6_lifecycle_vocabulary')", 3, 'P6 migrations are incomplete.');
            ...
            foreach (['trg_p6_result_rows_no_update','trg_p6_result_rows_no_delete','trg_p6_score_events_no_update','trg_p6_score_events_no_delete','trg_p6_appeal_events_no_update','trg_p6_appeal_events_no_delete'] as $trigger) {
