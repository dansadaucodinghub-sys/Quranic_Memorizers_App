...
final readonly class CompetitionP7VerifyConsoleCommand implements ConsoleCommand
{
    ...
    public function execute(ConsoleInput $input, ConsoleOutput $output): int
    {
        ...
        try {
            ...
            $this->requireCount($pdo, "SELECT COUNT(*) FROM qmdb_schema_migrations WHERE status='APPLIED' AND migration_id IN ('20260912140000_create_competition_live_operations','20260912141000_create_competition_live_projections','20260912142000_add_competition_live_operation_sequence','20260912143000_create_competition_result_publication','20260912144000_create_competition_appeal_adjudication','20260913100000_create_competition_p7_outbox','20260913110000_create_competition_p7_operation_receipts','20260913120000_create_competition_result_publication_projections')", 8, 'P7 migrations are incomplete.');
