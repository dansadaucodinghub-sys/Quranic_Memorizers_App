...
final readonly class PeopleProfileSecurityNotificationService
{
    ...
    public function create(int $accountId, AccountSecurityNotificationType $type, string $sourcePublicId, DateTimeImmutable $now): void
    {
        ...
        $this->notifications->createPendingIntent(
            ...
            $type,
            $this->deduplication->forEvent($type, $sourcePublicId, $target['account_public_id']),
            $target['locale'],
