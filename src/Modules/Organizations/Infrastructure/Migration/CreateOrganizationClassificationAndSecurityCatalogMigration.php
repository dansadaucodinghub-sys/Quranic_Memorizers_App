...
{
    public function id(): MigrationId { return new MigrationId('20260901040100_create_organization_classification_and_security_catalog'); }
    public function description(): string { return 'Create fixed Organization classifications and extend governed security constraints.'; }
    public function dependencies(): array { return [(new CreatePeopleGuardianshipAndSecurityCatalogMigration())->id()]; }
...
SQL),
    ...
    public function down(): array { return [new SqlMigrationStep(new MigrationStepId('001_drop_organization_classifications'), 'Drop the global Organization classifications.', 'DROP TABLE organization_classifications')]; }
