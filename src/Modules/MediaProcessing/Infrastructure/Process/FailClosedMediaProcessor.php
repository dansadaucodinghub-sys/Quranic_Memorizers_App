...
{
    public function process(string $contents,array $profile): string { throw new \RuntimeException('Trusted FFmpeg processing is not configured.'); }
    public function check(): array { return ['healthy'=>false,'engine'=>'FFMPEG','safe_code'=>'BINARY_UNAVAILABLE']; }
}
