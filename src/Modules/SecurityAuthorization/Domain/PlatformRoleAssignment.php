...
final readonly class PlatformRoleAssignment
{
    public function __construct(
        ...
        if ($accountInternalId < 1 || $roleInternalId < 1 || strlen($correlationId) !== 32) {
            throw new \InvalidArgumentException('Platform role assignment is invalid.');
        }
