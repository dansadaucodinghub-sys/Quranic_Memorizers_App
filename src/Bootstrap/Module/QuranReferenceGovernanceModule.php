...
final readonly class QuranReferenceGovernanceModule implements Module
{
    ...
    public function register(ModuleRegistrationContext $context): void
    {
        ...
        $context->service(ServiceDefinition::instance(QuranP4RequirementRegistry::class, 'quran.reference_governance', new QuranP4RequirementRegistry()));
        $context->service(ServiceDefinition::factory(QuranP4CloseoutReadinessCheck::class, 'quran.reference_governance', [DatabaseConnectionProvider::class, QuranP4RequirementRegistry::class], new ClosureServiceFactory(fn(DependencyResolver $r) => new QuranP4CloseoutReadinessCheck($this->projectRoot, ServiceReference::get($r, DatabaseConnectionProvider::class), ServiceReference::get($r, QuranP4RequirementRegistry::class)))));
        $context->service(ServiceDefinition::factory(QuranP4CloseoutVerifyConsoleCommand::class, 'quran.reference_governance', [QuranP4CloseoutReadinessCheck::class], new ClosureServiceFactory(fn(DependencyResolver $r) => new QuranP4CloseoutVerifyConsoleCommand(ServiceReference::get($r, QuranP4CloseoutReadinessCheck::class)))));
