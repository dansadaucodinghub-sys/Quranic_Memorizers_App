        ...
        $context->service(ServiceDefinition::factory(
            ...
            new ClosureServiceFactory(static fn (DependencyResolver $resolver): ViewRegistry =>
                new ViewRegistry([
                    ...
                    'fragments.community-comments' => $root . '/resources/views/fragments/community-comments.php',
                    'pages.community-bookmarks' => $root . '/resources/views/pages/community-bookmarks.php',
                    'fragments.community-bookmarks' => $root . '/resources/views/fragments/community-bookmarks.php',
                    'pages.community-feed' => $root . '/resources/views/pages/community-feed.php',
                      'fragments.community-feed' => $root . '/resources/views/fragments/community-feed.php',
                      'pages.community-profile' => $root . '/resources/views/pages/community-profile.php',
                      'fragments.community-profile' => $root . '/resources/views/fragments/community-profile.php',
                    'pages.community-creator-clips' => $root . '/resources/views/pages/community-creator-clips.php',
                    'fragments.community-creator-clips' => $root . '/resources/views/fragments/community-creator-clips.php',
                    'pages.community-clip-review' => $root . '/resources/views/pages/community-clip-review.php',
                    'fragments.community-clip-review' => $root . '/resources/views/fragments/community-clip-review.php',
                    'pages.community-moderation' => $root . '/resources/views/pages/community-moderation.php',
                    'fragments.community-moderation' => $root . '/resources/views/fragments/community-moderation.php',
                    'pages.community-safety' => $root . '/resources/views/pages/community-safety.php',
                    'fragments.community-safety' => $root . '/resources/views/fragments/community-safety.php',
                    'pages.community-followers' => $root . '/resources/views/pages/community-followers.php',
                    'fragments.community-followers' => $root . '/resources/views/fragments/community-followers.php',
                    'pages.community-following' => $root . '/resources/views/pages/community-following.php',
                    'fragments.community-following' => $root . '/resources/views/fragments/community-following.php',
                    ...
                    'pages.quran-public-home' => $root . '/resources/views/pages/quran-public-home.php',
                    'pages.quran-surah-directory' => $root . '/resources/views/pages/quran-surah-directory.php',
                    'pages.quran-surah-reader' => $root . '/resources/views/pages/quran-surah-reader.php',
                    'pages.quran-ayah-detail' => $root . '/resources/views/pages/quran-ayah-detail.php',
                    'pages.quran-partition' => $root . '/resources/views/pages/quran-partition.php',
                    'pages.quran-sajdahs' => $root . '/resources/views/pages/quran-sajdahs.php',
                    'pages.quran-search' => $root . '/resources/views/pages/quran-search.php',
                    'pages.quran-search-corpus' => $root . '/resources/views/pages/quran-search-corpus.php',
                    'fragments.quran-public-home' => $root . '/resources/views/fragments/quran-public-home.php',
                    'fragments.quran-surah-directory' => $root . '/resources/views/fragments/quran-surah-directory.php',
                    'fragments.quran-surah-reader' => $root . '/resources/views/fragments/quran-surah-reader.php',
                    'fragments.quran-ayah-detail' => $root . '/resources/views/fragments/quran-ayah-detail.php',
                    'fragments.quran-partition' => $root . '/resources/views/fragments/quran-partition.php',
                    'fragments.quran-sajdahs' => $root . '/resources/views/fragments/quran-sajdahs.php',
                    'fragments.quran-search' => $root . '/resources/views/fragments/quran-search.php',
                    'fragments.quran-search-corpus-integrity' => $root . '/resources/views/fragments/quran-search-corpus-integrity.php',
