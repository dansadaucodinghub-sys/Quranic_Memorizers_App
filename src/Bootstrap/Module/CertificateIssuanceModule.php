...
final readonly class CertificateIssuanceModule implements Module
{
    ...
    public function register(ModuleRegistrationContext $context): void
    {
        ...
        $context->service(ServiceDefinition::factory(CertificateIssuanceService::class, 'certificate.issuance', [CertificateIssuanceRepository::class, CertificateNumberAllocator::class, CertificateManifestCanonicalizer::class, CertificateLifecycle::class, CertificateSigningKeyProvider::class, CertificateArtifactRenderer::class, CertificateArtifactStore::class, AuthorizationRequirementGuard::class, StepUpGuard::class, IdentityRateLimiter::class, IdentityFingerprintGenerator::class, ApplicationConfiguration::class, CertificateProductionIssuanceGate::class, SecurityAuditEventAppender::class, TransactionManager::class, Clock::class], new ClosureServiceFactory(static fn (DependencyResolver $resolver): CertificateIssuanceService => new CertificateIssuanceService(ServiceReference::get($resolver, CertificateIssuanceRepository::class), ServiceReference::get($resolver, CertificateNumberAllocator::class), ServiceReference::get($resolver, CertificateManifestCanonicalizer::class), ServiceReference::get($resolver, CertificateLifecycle::class), ServiceReference::get($resolver, CertificateSigningKeyProvider::class), ServiceReference::get($resolver, CertificateArtifactRenderer::class), ServiceReference::get($resolver, CertificateArtifactStore::class), ServiceReference::get($resolver, AuthorizationRequirementGuard::class), ServiceReference::get($resolver, StepUpGuard::class), ServiceReference::get($resolver, IdentityRateLimiter::class), ServiceReference::get($resolver, IdentityFingerprintGenerator::class), ServiceReference::get($resolver, ApplicationConfiguration::class), ServiceReference::get($resolver, CertificateProductionIssuanceGate::class), ServiceReference::get($resolver, SecurityAuditEventAppender::class), ServiceReference::get($resolver, TransactionManager::class), ServiceReference::get($resolver, Clock::class)))));
