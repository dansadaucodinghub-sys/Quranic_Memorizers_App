...
return static function (
    ...
    return new RouteCollection(
        ...
        new Route('workspace.media.index', [HttpMethod::GET], new RoutePattern('/workspace/media'), $mediaGovernance),
        new Route('workspace.media.approve.form', [HttpMethod::GET], new RoutePattern('/workspace/media/{assetId}/approve'), $mediaGovernance),
        new Route('workspace.media.approve', [HttpMethod::POST], new RoutePattern('/workspace/media/{assetId}/approve'), $mediaGovernance),
        new Route('workspace.media.reject.form', [HttpMethod::GET], new RoutePattern('/workspace/media/{assetId}/reject'), $mediaGovernance),
        new Route('workspace.media.reject', [HttpMethod::POST], new RoutePattern('/workspace/media/{assetId}/reject'), $mediaGovernance),
        new Route('workspace.media.withdraw-consent.form', [HttpMethod::GET], new RoutePattern('/workspace/media/{assetId}/withdraw-consent'), $mediaGovernance),
        new Route('workspace.media.withdraw-consent', [HttpMethod::POST], new RoutePattern('/workspace/media/{assetId}/withdraw-consent'), $mediaGovernance),
        new Route('workspace.media.consent-review.form', [HttpMethod::GET], new RoutePattern('/workspace/media/{assetId}/consent-review'), $mediaGovernance),
        new Route('workspace.media.consent-review', [HttpMethod::POST], new RoutePattern('/workspace/media/{assetId}/consent-review'), $mediaGovernance),
        new Route('workspace.media.hold.form', [HttpMethod::GET], new RoutePattern('/workspace/media/{assetId}/hold'), $mediaGovernance),
        new Route('workspace.media.hold', [HttpMethod::POST], new RoutePattern('/workspace/media/{assetId}/hold'), $mediaGovernance),
        new Route('workspace.media.release-hold.form', [HttpMethod::GET], new RoutePattern('/workspace/media/{assetId}/release-hold'), $mediaGovernance),
        new Route('workspace.media.release-hold', [HttpMethod::POST], new RoutePattern('/workspace/media/{assetId}/release-hold'), $mediaGovernance),
        new Route('workspace.media.remove.form', [HttpMethod::GET], new RoutePattern('/workspace/media/{assetId}/remove'), $mediaGovernance),
        new Route('workspace.media.remove', [HttpMethod::POST], new RoutePattern('/workspace/media/{assetId}/remove'), $mediaGovernance),
        new Route('workspace.media.archive.form', [HttpMethod::GET], new RoutePattern('/workspace/media/{assetId}/archive'), $mediaGovernance),
