...
final readonly class P2FreezeVerifier
{
    ...
    private function verifyP3AuthorizationBoundary(string $root, string $state, VerificationReport $report): void
    {
        ...
        $authorized = is_string($contents) && (str_contains($contents, 'authorization: QMDB-P3-OPEN-B01') || str_contains($contents, 'authorization: QMDB-P3-B02-EXEC') || str_contains($contents, 'authorization: QMDB-P3-B03-EXEC') || str_contains($contents, 'authorization: QMDB-P3-B04-EXEC') || str_contains($contents, 'authorization: QMDB-P3-B05-EXEC') || str_contains($contents, 'authorization: QMDB-P3-B06-EXEC') || str_contains($contents, 'authorization: QMDB-P3-CLOSE'));
