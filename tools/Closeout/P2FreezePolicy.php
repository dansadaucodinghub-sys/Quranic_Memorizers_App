...
final class P2FreezePolicy
{
    ...
    private const P3_CLOSE_EXTENSION_PREFIXES = [
        ...
        'tools/Closeout/P3GovernanceRefreshFreezePolicy.php',
        'tools/Closeout/P3GovernanceRefreshFreezeGenerator.php',
        'tools/Closeout/P3GovernanceRefreshFreezeVerifier.php',
        ...
        'tools/Ci/generate-p3-governance-refresh-freeze.php',
