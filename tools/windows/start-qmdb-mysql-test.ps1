...
GRANT SELECT, INSERT, UPDATE, DELETE, CREATE, CREATE TEMPORARY TABLES, ALTER, DROP, INDEX, REFERENCES, TRIGGER ON ``$databaseName``.* TO '$runtimeUser'@'127.0.0.1';
GRANT SELECT, INSERT, UPDATE, DELETE, CREATE, ALTER, DROP, INDEX, REFERENCES, TRIGGER ON ``$databaseName``.* TO '$schemaUser'@'127.0.0.1';
FLUSH PRIVILEGES;
"@
