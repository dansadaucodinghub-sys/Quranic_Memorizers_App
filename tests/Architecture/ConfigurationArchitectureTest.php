    ...
    public function testDotenvExampleContainsOnlyApprovedNonSecretAssignments(): void
    {
        ...
        foreach (file($this->projectRoot() . '/.env.example', FILE_IGNORE_NEW_LINES) ?: [] as $line) {
            ...
            if (
                ...
                'AUTH_SECURITY_AUDIT_HMAC_KEY',
                'AUTH_PROFILE_CLAIM_PAIRING_HMAC_KEY',
                'DB_PASSWORD',
                'DB_SCHEMA_PASSWORD',
                ], true)
            ) {
        ...
        self::assertSame([
            ...
            'AUTH_SECURITY_AUDIT_HMAC_KEY',
            'AUTH_SECURITY_AUDIT_HMAC_KEY_VERSION',
            'AUTH_SECURITY_AUDIT_METADATA_MAX_BYTES',
            'AUTH_SECURITY_AUDIT_VERIFY_BATCH_SIZE',
            'AUTH_SECURITY_AUDIT_CHECKPOINT_INTERVAL_SECONDS',
            'AUTH_SECURITY_AUDIT_CHECKPOINT_MAX_STREAMS',
            'AUTH_ACCOUNT_STATE_JUSTIFICATION_MAX_BYTES',
            'AUTH_ACCOUNT_STATE_REFERENCE_MAX_BYTES',
            'AUTH_ACCOUNT_STATE_WINDOW_SECONDS',
            'AUTH_ACCOUNT_STATE_MAX_ATTEMPTS',
            'PERSON_MINOR_THRESHOLD_YEARS',
            'PERSON_MAX_AGE_YEARS',
            'PERSON_PROFILE_NAME_MAX_BYTES',
            'PERSON_PROFILE_SEARCH_NAME_MAX_BYTES',
            'PERSON_PROFILE_MAX_DEPENDENTS_PER_GUARDIAN',
            'PERSON_PROFILE_MUTATION_WINDOW_SECONDS',
            'PERSON_PROFILE_MUTATION_MAX_ATTEMPTS',
            'DEPENDENT_PROFILE_CREATION_WINDOW_SECONDS',
            'DEPENDENT_PROFILE_CREATION_MAX_ATTEMPTS',
            'ORGANIZATION_AFFILIATION_REQUEST_TTL_SECONDS',
            'ORGANIZATION_AFFILIATION_CODE_ENTROPY_BITS',
            'ORGANIZATION_AFFILIATION_TITLE_MAX_BYTES',
            'ORGANIZATION_AFFILIATION_MAX_ROLES',
            'ORGANIZATION_AFFILIATION_MAX_UNITS',
            'ORGANIZATION_AFFILIATION_MAX_PAGE_SIZE',
            'ORGANIZATION_AFFILIATION_MAINTENANCE_BATCH_SIZE',
            'ORGANIZATION_AFFILIATION_REQUEST_WINDOW_SECONDS',
            'ORGANIZATION_AFFILIATION_REQUEST_MAX_ATTEMPTS',
            'ORGANIZATION_AFFILIATION_RESPONSE_WINDOW_SECONDS',
            'ORGANIZATION_AFFILIATION_RESPONSE_MAX_ATTEMPTS',
            'ORGANIZATION_AFFILIATION_MUTATION_WINDOW_SECONDS',
            'ORGANIZATION_AFFILIATION_MUTATION_MAX_ATTEMPTS',
            'AUTH_PROFILE_CLAIM_PAIRING_HMAC_KEY',
            'AUTH_PROFILE_CLAIM_PAIRING_HMAC_KEY_VERSION',
            'PERSON_PROFILE_CLAIM_PAIRING_ENTROPY_BITS',
            'PERSON_PROFILE_CLAIM_PAIRING_TTL_SECONDS',
            'PERSON_PROFILE_CLAIM_PAIRING_MAX_ATTEMPTS',
            'PERSON_PROFILE_CLAIM_TTL_SECONDS',
            'PERSON_PROFILE_CLAIM_MAX_PAGE_SIZE',
            'PERSON_PROFILE_DUPLICATE_MAX_PAGE_SIZE',
            'PERSON_PROFILE_DUPLICATE_MAX_AFFECTED_AFFILIATIONS',
            'PERSON_PROFILE_DUPLICATE_MAX_CONSENT_AUTHORITIES',
            'PERSON_PROFILE_REVIEW_JUSTIFICATION_MAX_BYTES',
            'PERSON_PROFILE_REVIEW_REFERENCE_MAX_BYTES',
            'PERSON_PROFILE_CLAIM_MAINTENANCE_BATCH_SIZE',
            'PERSON_PROFILE_CLAIM_WINDOW_SECONDS',
            'PERSON_PROFILE_CLAIM_MAX_ATTEMPTS',
            'PERSON_PROFILE_DUPLICATE_WINDOW_SECONDS',
            'PERSON_PROFILE_DUPLICATE_MAX_ATTEMPTS',
            'MAILER_DSN',
            'MAIL_FROM_ADDRESS',
            'MAIL_FROM_NAME',
            'WORKER_MAX_JOBS',
