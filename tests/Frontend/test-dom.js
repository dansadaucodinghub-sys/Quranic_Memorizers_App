...
export function installDom(html = '<!doctype html><html lang="en"><body><div id="qmdb-live-region"></div></body></html>', url = 'http://localhost/') {
    ...
    for (const name of ['window', 'document', 'location', 'DOMParser', 'Element', 'HTMLElement', 'HTMLAnchorElement', 'HTMLButtonElement', 'HTMLDialogElement', 'HTMLFormElement', 'HTMLSelectElement', 'FormData', 'CSS']) {
