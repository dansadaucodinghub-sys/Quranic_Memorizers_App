...
final class P3SupersedingFreezeTest extends TestCase
{
    ...
    public function testLedgerRejectsBroadOrTamperedAuthorization(): void
    {
        ...
        $valid = ['ledger_id' => PostP3ExtensionLedger::ID, 'base_freeze' => 'QMDB-P3-FRZ-002', 'entries' => [$entry]];
        $ledger->verify($valid);
        ...
        $ledger->verify(['ledger_id' => PostP3ExtensionLedger::ID, 'base_freeze' => 'QMDB-P3-FRZ-002', 'entries' => [$entry]]);
    }
}
