...
final class P2FreezeTest extends TestCase
{
    public function testPolicyGovernsP2EvidenceAndExcludesGeneratedAndSelfReferentialFiles(): void
    {
        ...
        self::assertTrue($policy->isP3B05Extension('src/Modules/IdentityResolution/Application/ProfileClaimAcceptanceService.php'));
        ...
        self::assertTrue($policy->isP3B05MutableExistingPath('src/Modules/SecurityWeb/Csrf/CsrfAction.php'));
        self::assertTrue($policy->isP3B05MutableExistingPath('phpunit.xml.dist'));
        self::assertTrue($policy->isP3B05MutableExistingPath('resources/translations/ar.php'));
        self::assertTrue($policy->isP3B05MutableExistingPath('tests/Frontend/test-dom.js'));
        self::assertTrue($policy->isP3B05MutableExistingPath('public/assets/js/mutation-fetch-client.js'));
        self::assertTrue($policy->isP3B05MutableExistingPath('tests/Integration/MySql/P2IdentityMultiFactorIntegrationTest.php'));
        self::assertTrue($policy->isP3B05MutableExistingPath('docs/operations/quality-attribute-parameter-register.md'));
        self::assertTrue($policy->isP3B05MutableExistingPath('docs/project/open-decisions.md'));
        self::assertTrue($policy->isP3B05MutableExistingPath('docs/project/risk-register.md'));
