...
?>
<section data-qmdb-fragment-root data-qmdb-modal-content aria-labelledby="passkey-revoke-heading">
    <p><?= $escape->escapeText($translator->trans('passkey.revoke_intro', ['name' => $view->string('passkey_name')])) ?></p>
    <form method="post" action="/account/security/passkeys/<?= $escape->escapeAttribute($view->string('passkey_id')) ?>/revoke" data-qmdb-progressive-form>
