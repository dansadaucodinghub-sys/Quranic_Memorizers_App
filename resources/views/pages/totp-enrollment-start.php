...
<article class="shell identity-page">
    ...
    <h1 id="totp-heading" tabindex="-1"><?= $escape->escapeText($translator->trans('totp.start_heading')) ?></h1>
    <p class="lead"><?= $escape->escapeText($translator->trans('totp.start_intro')) ?></p>
